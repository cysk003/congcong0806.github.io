...
- [Quantumult X](https://apps.apple.com/us/app/quantumult-x/id1443988620) $4.99 (支持SS/SSR)
...
##### Windows 客户端
- [Clash for Windows](https://github.com/Fndroid/clash_for_windows_pkg/releases) Clash的Windows图形客户端,简称:CFW (支持SS/V2Ray)
- [Clash](https://github.com/Dreamacro/clash/releases) 一个Go语言开发的多平台代理客户端 (支持SS/V2Ray)
- [ClashR](https://t.me/clashr4ssr) 支持SSR的Clash客户端 (支持SS/SSR/V2Ray)
- [ClashRX](https://t.me/clashr4ssr) 支持SSR的Clash客户端 (支持SS/SSR/V2Ray)
...
- [ClashRA](https://t.me/clashr4ssr) 支持SSR的Clash客户端 (支持SS/SSR/V2Ray)
