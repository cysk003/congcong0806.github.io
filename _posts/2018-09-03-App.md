...
* Office 365 拼车 ¥94元/年 [获取优惠](https://partner.lizhi.io/congcong/office_365_share)
    * `[Mac/Win]体验云端办公与学习的魅力`
...
* PDFelement 7  [获取优惠](https://partner.lizhi.io/congcong/pdfelement)
    * `[Mac/Win]PDF修改编辑软件 原PDFelement 7`
* ProtoPie [获取优惠](https://partner.lizhi.io/congcong/protopie)
    * `[Mac/Win]谷歌、阿里设计师都在用的高保真交互原型设计工具,一小时打造最逼真的交互原型`
* NTFS for Mac 助手 [获取优惠](https://partner.lizhi.io/congcong/aibotech_ntfs_for_mac)
    * `[Mac]macOS 平台性价比最高的 NTFS 工具,解决移动硬盘读写问题`
...
* Internet Download Manager [获取优惠](https://partner.lizhi.io/congcong/idm)
    * `[Win] 备受好评的下载工具`
...
* PDFelement Express    [获取优惠](https://partner.lizhi.io/congcong/pdfelement_express)
    * `[Mac]轻巧易用 PDF 阅读编辑工具`
* PhoneClean [获取优惠](https://partner.lizhi.io/congcong/phoneclean)
    * `[Mac/Win] iOS瘦身优化 垃圾隐私清理 提速`
* Fences    [获取优惠](https://partner.lizhi.io/congcong/fences)
    *  `[Win]Windows 桌面图标管理神器`
* 扫描全能王    [获取优惠](https://partner.lizhi.io/congcong/camscanner)
    *  `[iOS/Android]OCR识别图片转文字 扫描件`

###### 实体商品
* Nums [获取优惠](https://partner.lizhi.io/congcong/nums)
    * `[Mac]看似 Nums 是一张印刷数字&符号的薄膜.神奇的是,薄膜吸附在触摸板后,用户只需通过配套软件,就能让触摸板秒变数字键盘,并还能支持更多高效手势.`

###### 搭配套餐
* Bundle 搭配套餐专区 [获取优惠](https://partner.lizhi.io/congcong/bundle)
    * `在这里，挑选合适你的软件，打包带走`
* PhoneClean & iMazing 搭配套餐 [获取优惠](https://partner.lizhi.io/congcong/bundle_phoneclean_imazing)
    * `苹果手机高级管理套餐:PhoneClean 能深度清理 iOS 设备文件；iMazing 是专业的 iOS 备份及管理软件。`
* PhoneClean & MacBooster 搭配套餐 [获取优惠](https://partner.lizhi.io/congcong/bundle_eagle_jianguoyun)
    * `苹果设备清理优化套餐:PhoneClean 是 iOS 设备的深度清理工具；MacBooster 是 Mac 清理优化工具，可一键扫清电脑垃圾文件。`
...
* CleanMyPC & Process Lasso 搭配套餐 [获取优惠](https://partner.lizhi.io/congcong/bundle_cleanmypc_processlasso)
    * `Win 系统优化套装:CleanMyPC 能清理优化 Windows 系统，Process Lasso 能实时控制应用程序进程，让你的电脑告别卡顿。`
...
* Apowersoft 视频编辑王 [获取优惠](https://partner.lizhi.io/congcong/apowersoft_video_editor)
    * `[Mac/Win]专业视频设计/编辑/制`
* AnyDrop   [获取优惠](https://partner.lizhi.io/congcong/anydrop)
    * `[Mac] 拖拽快捷操作 动作捷径 菜单栏工具箱`
...
* EssentialPIM Pro [获取优惠](https://partner.lizhi.io/congcong/essentialpim_pro)
    * `[Win]个人信息管理工具 日程邮件整理`
* EagleFiler [获取优惠](https://partner.lizhi.io/congcong/eaglefiler)
    * `[Mac]文档网页邮件管理工具 搜索标记加密`
...
* FolderMill	[获取优惠](https://partner.lizhi.io/congcong/foldermill)
    * `[Win]企业文档自动处理打印办公文件`
* Folder Colorizer [获取优惠](https://partner.lizhi.io/congcong/folder_colorizer)
    * `[Win]文件夹颜色修改工具 整理文件`
...
###### I
* iText [获取优惠](https://partner.lizhi.io/congcong/itext)
    * `[Mac]截图PDF图片转文字OCR分段 翻译校对`
* iPic [获取优惠](https://partner.lizhi.io/congcong/ipic)
    * `[Mac]主流图床上传工具 支持 Markdown 语法`
...
* Klib  [获取优惠](https://partner.lizhi.io/congcong/klib)
    * `[Mac]Kindle 多看标注管理 书摘笔记导出工具软件`
...
###### N
* Navicat Premium   [获取优惠](https://partner.lizhi.io/congcong/navicat_premium)
    * `[Mac/Win] 强大的数据库管理和设计工具，Navicat Premium 可以在一个应用程序中同时连接MySQL/MariaDB/SQL Server/Oracle/PostgreSQL/SQLite 等多种数据库`
* Navicat Cloud   [获取优惠](https://partner.lizhi.io/congcong/navicat_cloud)
* Navicat Data Modeler [获取优惠](https://partner.lizhi.io/congcong/navicat_data_modeler)
* Navicat Monitor [获取优惠](https://partner.lizhi.io/congcong/navicat_monitor)
* Navicat for SQLite [获取优惠](https://partner.lizhi.io/congcong/navicat_for_sqlite)
* Navicat for Oracle [获取优惠](https://partner.lizhi.io/congcong/navicat_for_oracle)
* Navicat for SQL Server [获取优惠](https://partner.lizhi.io/congcong/navicat_for_sqlserver)
* Navicat for MariaDB [获取优惠](https://partner.lizhi.io/congcong/navicat_for_mariadb)
* Navicat for MongoDB [获取优惠](https://partner.lizhi.io/congcong/navicat_for_mongodb)
* Navicat for PostgreSQL [获取优惠](https://partner.lizhi.io/congcong/navicat_for_postgresql)
* Navicat for MySQL [获取优惠](https://partner.lizhi.io/congcong/navicat_for_mysql)
...
* One Switch   [获取优惠](https://partner.lizhi.io/congcong/one_switch)
    * `[Mac]菜单栏便捷开关 快速切换设置工具`
...
* RapidWeaver [获取优惠](https://partner.lizhi.io/congcong/rapidweaver)
    * `[Mac]网站博客设计制作软件 快速建站`
* Rotato [获取优惠](https://partner.lizhi.io/congcong/rotato)
    * `[Mac]Mockup 展示样机素材库 制作3D演示动画`
...
* SideNotes [获取优惠](https://partner.lizhi.io/congcong/sidenotes)
    * `[Mac]侧边栏笔记工具 支持 Markdown`
...
* Squash [获取优惠](https://partner.lizhi.io/congcong/squash)
    * `[Mac]图片压缩转换软件 文件重命名`
* SHADE Sandbox   [获取优惠](https://partner.lizhi.io/congcong/shade_sandbox)
    * `[Win]沙盒软件 隔离病毒木马 保护电脑安`
...
###### 中
* 白描   [获取优惠](https://partner.lizhi.io/congcong/baimiao)
    * `[iOS/Android]图片转文字OCR PDF文档扫描 APP`
* 纯纯写作   [获取优惠](https://partner.lizhi.io/congcong/writer_drakeet)
    * `[Android]不丢失文本编辑器 支持云备份Markdown`
...
* 天若 OCR [获取优惠](https://partner.lizhi.io/congcong/tianruo_ocr)
    * `[Win]图片文字识别翻译 截图标注贴图`
